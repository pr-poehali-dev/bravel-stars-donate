...
const PRODUCTS = [
  ...
  },
  {
    id: 2,
    name: "Боевой пропуск",
    description: "Доступ к сезонному контенту на 30 дней",
    price: 299,
    oldPrice: 499,
    badge: "ХАЙП",
  ...
  },
  {
    id: 3,
    name: "VIP-статус",
    description: "1000 кристаллов + эксклюзивный скин",
    price: 799,
    oldPrice: 999,
    badge: "СКИДКА",
  ...
  },
  {
    id: 4,
    name: "Мега-набор",
    description: "3000 кристаллов + 3 редких скина + буст ×2",
    price: 1999,
    oldPrice: 2999,
    badge: "ТОП",
    badgeClass: "badge-hot",
  ...
  },
  {
    id: 5,
    name: "Кристаллы ×500",
    description: "500 игровой валюты на аккаунт",
    price: 499,
    oldPrice: null,
    badge: null,
    badgeClass: "",
  ...
  },
  {
    ...
    description: "Гарантия легендарного предмета",
    price: 599,
    oldPrice: 799,
    badge: "ЛЕГЕНДА",
    badgeClass: "badge-sale",
...
const FAQ_ITEMS = [
  {
    q: "Как быстро выдают донат после оплаты?",
    a: "Выдача происходит автоматически в течение 1–3 минут после подтверждения оплаты. В 99% случаев — моментально.",
  },
  {
    q: "Как использовать промокод?",
    a: "Введи промокод в специальное поле при оформлении заказа. Скидка применится автоматически. Попробуй NEWGAMER для -15%!",
  },
  {
    q: "Что если донат не пришёл?",
    a: "Напиши в поддержку с номером заказа — разберёмся в течение 15 минут. Гарантируем возврат или повторную выдачу.",
  },
  {
  ...
  {
    q: "Безопасно ли это для аккаунта?",
    a: "Да. Мы используем официальные методы пополнения — никаких взломов и читов. Аккаунт в полной безопасности.",
  },
  {
    q: "Есть ли реферальная программа?",
    a: "Да! Приглашай друзей и получай 5% от каждой их покупки на баланс. Ссылка доступна в личном кабинете.",
  },
];
